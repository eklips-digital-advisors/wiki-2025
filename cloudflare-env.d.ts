/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 91141be688897a527f59599a902ea14d)
...
declare namespace Cloudflare {
	interface Env {
		...
		BEANSTALK_PWD: string;
		BEANSTALK_URL: string;
		BEANSTALK_USR: string;
		CLOUDFLARE_EKLIPS: string;
		CLOUDFLARE_MADIS: string;
		FRONT_PWD: string;
		FRONT_USR: string;
		NEXT_PUBLIC_SERVER_URL: string;
		PINGDOM_TOKEN: string;
		PINGDOM_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URI" | "PAYLOAD_SECRET" | "BEANSTALK_PWD" | "BEANSTALK_URL" | "BEANSTALK_USR" | "CLOUDFLARE_EKLIPS" | "CLOUDFLARE_MADIS" | "FRONT_PWD" | "FRONT_USR" | "NEXT_PUBLIC_SERVER_URL" | "PINGDOM_TOKEN" | "PINGDOM_URL" | "TEAMWORK_API_KEY" | "TEAMWORK_BASE_URL" | "AZURE_DEVOPS_PAT">> {}
}
