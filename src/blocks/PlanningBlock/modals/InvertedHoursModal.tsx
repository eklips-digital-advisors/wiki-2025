...
import { handleUserSaveDateClickInverted } from '@/blocks/PlanningBlock/utils/inverted/handleUserSaveDateClickInverted'
import {
  handleUserDeleteDateClickInverted
} from '@/blocks/PlanningBlock/utils/inverted/handleUserDeleteDateClickInverted'
...
export const InvertedHoursModal: React.FC<Props> = ({
  hoursModalSlug,
  hoursInput,
  setHoursInput,
  clickedInfo,
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-2 items-center flex-wrap">
            <Button
              ...
              onClick={async () => {
                await handleUserSaveDateClickInverted(clickedInfo, router, hoursInput, setTimeEntriesState, setToast)
                setHoursInput('')
            ...
            {clickedInfo?.event &&
              <Button
                ...
                className="cursor-pointer self-start"
                onClick={async () => {
                  await handleUserDeleteDateClickInverted(clickedInfo, router, setTimeEntriesState, setToast)
                  setHoursInput('')
                  toggleModal(hoursModalSlug)
                }}
              >
