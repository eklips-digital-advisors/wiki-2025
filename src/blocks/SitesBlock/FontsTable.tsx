...
export const FontsTable = ({ fonts }: { fonts?: DetectedFont[] }) => {
  return (
    <span className="group relative inline-block">
      ...
      <span className="absolute left-0 top-0 mt-2 w-[460px] max-h-[260px] overflow-y-auto bg-white border border-gray-300 shadow-lg rounded-lg p-2 z-50 opacity-0 invisible group-hover:visible group-hover:opacity-100 group-hover:scale-100 transition-opacity transition-transform duration-300 text-sm">
        {fonts?.length ? (
